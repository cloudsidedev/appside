...
setup(
    ...
    description='AppFlow is a multitenant environment automation tool based on Ansible.',  # Required
    ...
    url='https://github.com/ttssdev/appflow',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='TTSS',  # Optional
